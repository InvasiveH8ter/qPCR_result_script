...
IPC_POS_delay <- filter(IPC_sample_sum, Sample.Name == "IPC_POS")
IPC <- IPC_POS_delay[,2]
...
write.csv(result_table, "C:/Users/leifh/OneDrive/Documents/Luikart Project/MISC/Deliverables/qPCR_R_data/result_table_test.csv")
